...
class TaskFormViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private val _openTask = MutableLiveData<TaskModel>()
    val openTask:LiveData<TaskModel> = _openTask
    ...
    fun load(id:Int){
        taskRepository.loadTask(id, object : APIListener<TaskModel>{
            override fun onSuccess(responseModel: TaskModel) {
                _openTask.value = responseModel
            }
